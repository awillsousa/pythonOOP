...
#                    AssentoEmergencia, 
#                    AssentoReservado
# A linha de import abaixo executa uma importação
# equivalente a este mostrado acima. Com a diferença
# que a importação explícita nos deixa perceber, 
# exatamente as classes que estão sendo importadas
